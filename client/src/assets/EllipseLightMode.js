...
function EllipseLightMode({stroke, radius, normalizedRadius, circumference, strokeDashoffset, strokeColor, circlePos, goal}) {
  return (
      <Fragment>
<svg height={radius * 3.1} width={radius * 3.1}>
        <g filter='url(#filter0_dd)'>
          <circle cx={circlePos} cy={circlePos} r={radius} fill='#eff2f5' />
        </g>
        <defs>
...
export default EllipseLightMode
